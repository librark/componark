...
export class List extends Component {
  ...
  init(context = {}) {
    this.source = this.source || /** @type {Array} */ (context.source) || []
    this.template = this.template || context.template || ((data) => `${data}`)
  ...
  render() {
    ...
    const template = itemTemplate ? this._format(itemTemplate) : this.template
