...
.ark-button[background=warning] {
  background: (var(--warning)) radial-gradient(circle, transparent 1%, (var(--warning)) 1%) center/15000%;
  color: white;
}
...
.ark-button[background=info] {
  background: (var(--info)) radial-gradient(circle, transparent 1%, (var(--info)) 1%) center/15000%;
  color: white;
}
...
.ark-button[background=muted] {
  background: (var(--muted)) radial-gradient(circle, transparent 1%, (var(--muted)) 1%) center/15000%;
  color: white;
}
