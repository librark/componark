...
export class CardDemo extends Component {
  ...
  render() {
    this.content = /* html */ `
    <div class="row rotate-inverse-tiny-active
      outline-solid-active outline-normal
      outline-secondary
      transition-small padding-normal
      roundness-normal shadow-normal
    ...
    <div class="row 
      color-primary
      background-warning
      background-alpha-low-hover
      color-alpha-high-hover
      none-hover
      "
      style="width: 300px; height: 150px;">
      <div class="center">ONE</div>
    ...
    <div class="scale-normal-hover transition-small column padding-normal roundness-normal shadow-normal background-primary"
      style="width: 300px; height: 150px;">
      <div class="center">ONE</div>
      <div class="center">TWO</div>
      <div class="center">TWO</div>
    ...
    <div class="row padding-normal roundness-normal background-primary"
      style="width: 300px; height: 150px;">
      ...
      <div class="column background-light column-span-huge" >
        ...
        row-span-normal filter contrast-high drop-shadow-high
        padding-large">
    ...
    <p class="filter-hover blur-low transition-large">HOLA MUNDO</p>

    <button class="scale-huge-active background-danger color-success cursor-pointer 
      filter-active brightness-high transition-tiny
      ">FILTER MUNDO</button>

    <p class="background-secondary">SHADOWS</p>

    <ark-card no-borders class="shadow-tiny shadow-small-active" title="Borderless card" subtitle="subtitle card">
      <div class="cursor-pointer bold italic outline-solid outline-huge outline-success
        border-left-solid border-right-dashed border-primary border-normal 
        container color-light background-dark
        filter-hover invert-low saturate-high line-large
        transition-small
        ">
