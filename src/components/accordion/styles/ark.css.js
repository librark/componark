...
.ark-accordion-tab {
    ...
    color: inherit;
    min-height: 48px;
    transition: min-height 280ms cubic-bezier(0.4, 0, 0.2, 1) 0ms,background-color 150ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;background-color: #fff;
...
.ark-accordion-tab[active] div.ark-accordion-tab__header small .ark-icon.ark-icon i {
...
.ark-accordion-tab__content {
  ...
  -webkit-animation-timing-function: margin 150ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;
