...
export class SidebarDemo extends HTMLElement {
            ...
            <ark-sidebar opened>
                <ark-sidebar-content>
                    ...
                    <ark-sidebar-content-header>
                        <ark-sidebar-content-header-title>titulo xxx</ark-sidebar-content-header-title>
                        <ark-sidebar-content-header-subtitle>subtitulo xxx</ark-sidebar-content-header-subtitle>
                    </ark-sidebar-content-header>
    ...
    _bind() {
        ...
        this.sidebar = (/** @type {import('../../../../components/sidebar'
		).Sidebar} */ (this.querySelector('ark-sidebar')))
    }
